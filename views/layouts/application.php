...
<head>
	...
	<script src="<?= BASE_URL ?>public/jquery/jquery-latest.js"></script>
	<script type="text/javascript" src="<?= BASE_URL ?>public/bootstrap/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="<?= BASE_URL ?>public/script/script.js"></script>
...
<body>
	<header id='header'>
		<a href="<?= BASE_URL ?>"><img src="<?= BASE_URL ?>public/images/logo.png">
			<h2 class="logo">9XWatch</h2>
		</a>
		<ul class="header-menu">
			<?php
			if ((!isset($_SESSION['user']))) { ?>
				<!-- if(($_SESSION['user']) == ""){ ?> -->
				<li><a href="<?= BASE_URL ?>index/signin" id="s-s" data-stt='nosignin'>Đăng nhập</a>
					<div class='mn-ef'></div>
				</li>
				<li><a href="<?= BASE_URL ?>index/signup">Đăng ký</a>
					<div class='mn-ef'></div>
				</li>
			<?php } else { ?>
				<li><a onclick="$('#user-setting').toggle()" id="s-s">Chào <?php echo $_SESSION['user']['ten'] ?></a>
					<div class='mn-ef'></div>
				</li>
				<div id='user-setting'>
					<ul>
			...
			<?php }
			?>
			<li><a href="client/viewcart"><i class="glyphicon glyphicon-shopping-cart"></i> Giỏ hàng</a>
				<div class="mn-ef"></div>
			</li>
		</ul>
	...
	<nav class="navbar navbar-default" role="navigation" id="nav">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<div class="navbar-right navbar-form searchbox-desktop">
